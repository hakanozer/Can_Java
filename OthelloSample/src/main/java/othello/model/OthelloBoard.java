...
public class OthelloBoard implements Visitable {
	...
	public char get(int row, int col) {
		OthelloGetTokenVisitor getTokenVisitor = new OthelloGetTokenVisitor(row, col);
		this.accept(getTokenVisitor);
		return getTokenVisitor.getToken();
	}

	/**
	 * Accepts visitors to perform appropriate operations
	 */
